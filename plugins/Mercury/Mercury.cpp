	...
	InstrumentView( _instrument, _parent )
{
	...
	m_fundamentalKnob = new Knob( KnobType::Small17, this );
	...
	m_exciterDelayFadeKnob = new Knob( KnobType::Small17, this );
