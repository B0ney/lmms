	...
	m_controls(controls)
{
	...
	Knob * cutoffKnob = new Knob(KnobType::Bright26, this);
	...
	Knob * resonanceKnob = new Knob(KnobType::Bright26, this);
	...
	Knob * delayKnob = new Knob(KnobType::Bright26, this);
	...
	TempoSyncKnob * rateKnob = new TempoSyncKnob(KnobType::Bright26, this);
	...
	Knob * phaseKnob = new Knob(KnobType::Bright26, this);
	...
	Knob * inFollowKnob = new Knob(KnobType::Bright26, this);
	...
	Knob * distortionKnob = new Knob(KnobType::Small17, this);
	...
	Knob * analogDistKnob = new Knob(KnobType::Small17, this);
	...
	Knob * delayControlKnob = new Knob(KnobType::Small17, this);
	...
	Knob * cutoffControlKnob = new Knob(KnobType::Small17, this);
	...
	LedCheckBox * enableLFO = new LedCheckBox("", this, tr("Enable LFO"), LedCheckBox::LedColor::Green);
